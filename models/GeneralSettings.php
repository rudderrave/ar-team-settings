...
namespace arteam\settings\models;

use arteam\behaviors\MultilingualSettingsBehavior;
use Yii;
...
class GeneralSettings extends BaseSettingsModel
{
    ...
    {
        return [
            'title' => Yii::t('arteam/settings', 'Site Title'),
            'description' => Yii::t('arteam/settings', 'Site Description'),
            'email' => Yii::t('arteam/settings', 'Admin Email'),
            'timezone' => Yii::t('arteam/settings', 'Timezone'),
            'dateformat' => Yii::t('arteam/settings', 'Date Format'),
            'timeformat' => Yii::t('arteam/settings', 'Time Format'),
        ];
    }
